...
model_path = r"C:\Users\User\Documents\FYP\FYP-EggGrading\storage\vNov29FullWeight\sizeModel.h5"
...
if len(sys.argv) < 2:
    sys.stderr.write("Usage: python classifyV29fullWeight.py <image_path>\n")
    sys.exit(1)

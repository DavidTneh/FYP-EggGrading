...
model_path = r"C:\Users\User\Documents\FYP\FYP-EggGrading\storage\1DecFlipGrey\sizeModel.keras"
...
if len(sys.argv) < 2:
    sys.stderr.write("Usage: python classifyV1DecFlipGrey.py <image_path>\n")
    sys.exit(1)

...
model_path = r"C:\Users\User\Documents\FYP\FYP-EggGrading\storage\vNov30\optimized_weight_model.h5"
...
# Custom objects to handle mixed precision layers
class CastLayer(Layer):
    """Dummy layer for Cast used in mixed precision."""
    def call(self, inputs):
        return inputs

custom_objects = {
    "Cast": CastLayer,  # Register 'Cast' layer
    "Policy": Policy,   # Register mixed precision policy
}
...
if len(sys.argv) < 2:
    sys.stderr.write("Usage: python classifyV30SelfCaptured.py <image_path>\n")
    sys.exit(1)

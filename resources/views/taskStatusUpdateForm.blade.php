    ...
    <form method="POST" action="{{ route('employee.updateTaskStatus') }}">
        ...
        <div class="form-group">
            ...
            <input type="text" class="form-control" id="taskName" name="taskName"
                value="{{ $taskScheduling->taskName }}" readonly>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="collectionStatus" name="collectionStatus">
                ...
                <option value="completed" {{ old('collectionStatus')=='completed' ? 'selected' : '' }}>Completed
                </option>
            </select>
        </div>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="feedingStatus" name="feedingStatus">
                <option value="pending" {{ old('feedingStatus', 'pending' )=='pending' ? 'selected' : '' }}>Pending
                </option>
                <option value="in_progress" {{ old('feedingStatus')=='in_progress' ? 'selected' : '' }}>In Progress
                </option>
        ...
        <div class="form-group">
            ...
            <select class="form-control" id="cullingStatus" name="cullingStatus">
                <option value="pending" {{ old('cullingStatus', 'pending' )=='pending' ? 'selected' : '' }}>Pending
                </option>
                <option value="in_progress" {{ old('cullingStatus')=='in_progress' ? 'selected' : '' }}>In Progress
                </option>

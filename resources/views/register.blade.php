                    ...
                    <div class="col-md-8 p-5">
                        ...
                        <form method="POST" action="{{ route('admin.register.post') }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="form-text text-muted">
                                            Your password must be 8-20 characters long, contain at least one uppercase
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <small class="form-text text-muted">
                                            Ensure that the confirmation password matches the password entered above.
                                        </small>
                                    </div>
                                </div>
                                <div class="col-md-6">
                            ...
                            <button type="submit" class="btn btn-primary w-100"
                                style="background-color: #007bff;">Sign
                                Up</button>
                        </form>

  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light" style="background-color: #343a40; color: #ffffff;">
    ...
    <ul class="navbar-nav">
        ...
        <li class="nav-item d-none d-sm-inline-block">
            <b><a href="../../index3.html" class="nav-link" style="color: #ffffff;">Home</a></b>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="color: #ffffff;">Grade Egg</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="color: #ffffff;">Task Scheduling</a>
        </li>
        <li class="nav-item d-none d-sm-inline-block">
            <a href="#" class="nav-link" style="color: #ffffff;">Report</a>
        </li>
    </ul>

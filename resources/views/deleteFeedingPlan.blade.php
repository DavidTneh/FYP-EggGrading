...
<div class="container" style="width: 80%; margin-top: 20px;">
    <div class="row">
        <div class="col-md-12 mt-5">
            ...
            <form action="{{ route('feedingplan.destroy', $plan->feedingplanID) }}" method="POST">
                @csrf
                @method('DELETE')

                <!-- Hidden field to pass the feeding plan ID -->
                ...
                <div class="float-right">
                    ...
                    <a href="{{ route('feedingplan.index') }}" class="btn btn-secondary">Cancel</a>
                </div>
            </form>
        </div>
    </div>
